...
type QueryAllBalancesResponse struct {
	...
	Balances github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=balances,proto3,castrepeated=github.com/sisu-network/cosmos-sdk/types.Coins" json:"balances"`
...
type QueryTotalSupplyResponse struct {
	...
	Supply github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=supply,proto3,castrepeated=github.com/sisu-network/cosmos-sdk/types.Coins" json:"supply"`
}
