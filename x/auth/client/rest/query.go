...
import (
	...
	clientrest "github.com/sisu-network/cosmos-sdk/client/rest"
	...
	genutilrest "github.com/sisu-network/cosmos-sdk/x/genutil/client/rest"
)
...
func QueryAccountRequestHandlerFn(storeName string, clientCtx client.Context) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil {
			...
			// Ref: https://github.com/sisu-network/cosmos-sdk/issues/4923
