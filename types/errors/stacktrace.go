...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/sisu-network/cosmos-sdk/types/errors.Wrap",
		"github.com/sisu-network/cosmos-sdk/types/errors.Wrapf",
		"github.com/sisu-network/cosmos-sdk/types/errors.WithType",
