...
HTTPS_GIT := https://github.com/sisu-network/cosmos-sdk.git
...
ifeq ($(LEDGER_ENABLED),true)
  ifeq ($(OS),Windows_NT)
    ...
    ifeq ($(UNAME_S),OpenBSD)
      $(warning OpenBSD detected, disabling ledger support (https://github.com/sisu-network/cosmos-sdk/issues/1988))
    else
...
ldflags = -X github.com/sisu-network/cosmos-sdk/version.Name=sim \
		  -X github.com/sisu-network/cosmos-sdk/version.AppName=simd \
		  -X github.com/sisu-network/cosmos-sdk/version.Version=$(VERSION) \
		  -X github.com/sisu-network/cosmos-sdk/version.Commit=$(COMMIT) \
		  -X "github.com/sisu-network/cosmos-sdk/version.BuildTags=$(build_tags_comma_sep)"

# DB backend selection
ifeq (cleveldb,$(findstring cleveldb,$(COSMOS_BUILD_OPTIONS)))
  ldflags += -X github.com/sisu-network/cosmos-sdk/types.DBBackend=cleveldb
endif
ifeq (badgerdb,$(findstring badgerdb,$(COSMOS_BUILD_OPTIONS)))
  ldflags += -X github.com/sisu-network/cosmos-sdk/types.DBBackend=badgerdb
endif
# handle rocksdb
ifeq (rocksdb,$(findstring rocksdb,$(COSMOS_BUILD_OPTIONS)))
  CGO_ENABLED=1
  BUILD_TAGS += rocksdb
  ldflags += -X github.com/sisu-network/cosmos-sdk/types.DBBackend=rocksdb
endif
# handle boltdb
ifeq (boltdb,$(findstring boltdb,$(COSMOS_BUILD_OPTIONS)))
  BUILD_TAGS += boltdb
  ldflags += -X github.com/sisu-network/cosmos-sdk/types.DBBackend=boltdb
endif
...
mocks: $(MOCKS_DIR)
	...
	mockgen -package mocks -destination tests/mocks/tendermint_tendermint_libs_log_DB.go github.com/sisu-network/tendermint/libs/log Logger
.PHONY: mocks
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/sisu-network/cosmos-sdk/types"
	godoc -http=:6060
...
format:
	...
	find . -name '*.go' -type f -not -path "./vendor*" -not -path "*.git*" -not -path "./client/docs/statik/statik.go" -not -path "./tests/mocks/*" -not -name '*.pb.go' | xargs goimports -w -local github.com/sisu-network/cosmos-sdk
.PHONY: format
...
devdoc-init:
	$(DOCKER) run -it -v "$(CURDIR):/go/src/github.com/sisu-network/cosmos-sdk" -w "/go/src/github.com/sisu-network/cosmos-sdk" tendermint/devdoc echo
	# TODO make this safer
	$(call DEVDOC_SAVE)

devdoc:
	$(DOCKER) run -it -v "$(CURDIR):/go/src/github.com/sisu-network/cosmos-sdk" -w "/go/src/github.com/sisu-network/cosmos-sdk" devdoc:local bash
...
## Issue link: https://github.com/sisu-network/tendermint/issues/5021
